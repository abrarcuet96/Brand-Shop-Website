        ...
        <div className=" max-w-screen-xl mx-auto">
            <div className="flex  gap-5">
                ...
                <div className="flex flex-col w-1/2">
                    ...
                    <div>
                        <Link to='/myCart'><button className="border-4 border-slate-900 hover:border-fuchsia-500 p-5 w-full text-xl font-bold hover:text-fuchsia-500 rounded-lg text-slate-900">Add to cart</button></Link>
                    </div>
                </div>
            </div>
