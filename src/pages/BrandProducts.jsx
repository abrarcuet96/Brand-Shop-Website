...
const BrandProducts = () => {
    ...
    return (
        <div>
            {
                products.length > 0 ? <div className="mb-5 max-w-screen-xl mx-auto">

                    <div className="carousel w-full h-[50vh]">
                        <div id="slide1" className="carousel-item relative w-full">
                            <img src="https://i.ibb.co/L0zZn8G/bags-with-gifts-top-copy-space.jpg" className="w-full object-cover" />
                        ...
                        <div id="slide2" className="carousel-item relative w-full">
                            <img src="https://i.ibb.co/Jskqn63/modern-stationary-collection-arrangement.jpg" className="w-full object-cover" />
                            <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div id="slide3" className="carousel-item relative w-full">
                            <img src="https://i.ibb.co/tYX3Yyg/workplace-business-modern-male-accessories-laptop-black-background.jpg" className="w-full object-cover" />
                            <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                                <a href="#slide2" className="btn btn-circle">❮</a>
                                <a href="#slide4" className="btn btn-circle">❯</a>
                            </div>
