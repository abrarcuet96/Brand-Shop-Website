...
const Register = () => {
    ...
    return (
        <div>
            <div className="hero min-h-screen bg-[conic-gradient(at_bottom,_var(--tw-gradient-stops))] from-slate-900 via-purple-900 to-slate-900">
                <div className="hero-content flex-col lg:flex-row">
                    <div className="text-center lg:text-left lg:w-1/2">
                        <h1 className="text-2xl lg:text-5xl font-bold text-white">Elevate Your Style, Join BrandShop Today! <br />– <span className="text-white font-bold" style={highlightText}>Register Today!</span></h1>
                        <p className="py-6 text-xl text-white font-semibold">Register now to unlock a world of personalized style and exclusive fashion experiences at BrandShop.</p>
                        <Link to="/">
                                    ...
                                    <div className='flex flex-col  text-center'>
                                        <label>
                                            <input
                                                ...
                                                hidden
                                            />
                                            <div className='btn btn-primary bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white border border-gray-300 font-semibold cursor-pointer p-1 px-3 w-full rounded-lg'>
                                                {uploadButton}
                                            </div>
                                        </label>
                                    </div>
